    ...
    <>
      <S.Container>
        <S.Box onClick={handleShareModal}>
          ...
          <S.Text>공유</S.Text>
          {isToggledShareModal && (
            <ShareModal title="공유 하기" folderName={folderName} folderId={folderId} onClose={handleShareModal} />
          )}
        </S.Box>
        <S.Box onClick={handleInputModal}>
          ...
          <S.Text>이름 변경</S.Text>
          {isToggledInputModal && (
            <InputModal title="폴더 이름 변경" placeholder={folderName} onClose={handleInputModal}>
              변경하기
            </InputModal>
          )}
        </S.Box>
        <S.Box onClick={handleDeleteModal}>
          ...
          {isToggledDeleteModal && (
            <DeleteModal title="폴더 삭제" text={folderName} onClose={handleDeleteModal}>
              변경하기
            </DeleteModal>
          )}
        </S.Box>
